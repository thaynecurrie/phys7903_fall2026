...
#taking the SVD
 ...
 print('the maximum singular value is {0:.3e}'.format( np.amax(s,axis=-1,keepdims=True)[0]))
 print('the minimum singular value is {0:.3e}'.format( np.amin(s,axis=-1,keepdims=True)[0]))
